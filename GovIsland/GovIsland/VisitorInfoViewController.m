...
@synthesize myHistoryTable, myArray, myurlArray; 
...
-(void)goToWebView {
    ...
    HistoryDetailViewController *webViewController = [[HistoryDetailViewController alloc] initWithNibName:@"HistoryDetailViewController" bundle:nil];
