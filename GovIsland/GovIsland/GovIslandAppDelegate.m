...
@implementation GovIslandAppDelegate
...
-(void)switchToTab:(int)myIndex selectAnnotation:myAnnotationID withAnnotationType:myAnnotationToSelect {
    [_tabBarController setSelectedIndex:myIndex];
    
      SecondViewController *secondViewController = [[SecondViewController alloc] initWithNibName:@"SecondView" bundle:nil];
    
    [_tabBarController setSelectedViewController:secondViewController];
    [secondViewController selectAnnotation:myAnnotationID  withAnnotationType:myAnnotationToSelect];
}
